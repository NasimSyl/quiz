...
function Clock() {
    ...
    let finalYear = `${Day}/${Month}/${Year}` ;
    document.getElementById("Date").innerHTML=finalYear;
 ...
 let finaltTime =`${hours}:${minutes}:${second}`;

//  console.log(date)

 document.getElementById("clock").innerHTML=finaltTime;
     
//    Hours.innerHTML=hours;
//    Minit.innerHTML=minutes;
